  ...
  return (
    ...
    <div className="flex w-full justify-between">
     <div className="w-[48%]  px-11 py-8 rounded-[44px] bg-gradient-to-t from-[#08437D] to-[#0882BD]">
        <div className="img w-[100%] h-[90vh] flex justify-center items-center relative"><div className=" absolute border  border-[#ffffff3f] animate-ping h-[20vh] w-[20vh] rounded-full"></div><div className=" absolute border border-[#ffffff28] animate-ping h-[30vh] w-[30vh] rounded-full"></div><img className='h-[25vh] w-[25vh] rounded-full object-cover absolute z-10' src="https://media.licdn.com/dms/image/v2/D5603AQF8bYdkGLdfcA/profile-displayphoto-shrink_200_200/B56ZQ6W0nTGsAg-/0/1736145854489?e=1756944000&v=beta&t=OxxrDylxsjCszkGjKB9-vIi-aA07e5qCi221BEdKqCY" alt="" /></div>
        <div className="">
      ...
      <div className="w-[48%] border px-11 py-8 rounded-[44px] bg-gradient-to-br from-[#833ab4] via-[#fd1d1d] to-[#fcb045]">
        <div className="img w-[100%] h-[90vh] flex justify-center items-center"><img src={img} className='w-full' alt="" /></div>
        <div className="">
